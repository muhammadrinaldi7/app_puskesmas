        ...
        <div class="panel-header " style="background-color: #f39c12!important;">
          <div class="page-inner py-4">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
              <div>
                <h2 class="text-white pb-2 fw-bold">POLI GIGI</h2>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title"></h4>
                   <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modaltambah"><i class="fa fa-plus"></i> TAMBAH POLIGIGI</button>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="basic-datatables" class="display table table-striped table-hover" >
                      ...
                      <tbody>
                        <?php $no=1; foreach ($data_poligigi->result_array() as $i) :
                                                $id_poligigi=$i['id_poligigi'];
                                              ?>
                         <tr>
                                                ...
                                                <button style="margin: 2px;" type="button"  class="btn btn-info mdi mdi-pencil btn-sm" data-toggle="modal" data-target="#ModalUpdate<?php echo $id_poligigi;?>"><i class="fa fa-edit"></i> EDIT</button>

                                                <button style="margin: 2px;" type="button"  class="btn btn-danger mdi mdi-pencil btn-sm" data-toggle="modal" data-target="#ModalHapus<?php echo $id_poligigi;?>"><i class="fa fa-trash"></i> DELETE</button>
...
<!--Tambah Data-->
       <form  action="<?php echo base_url().'poligigi/simpan_poligigi'?>" method="post" method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content">
                                <div class="modal-header bg-success white">
                                  <h4 class="modal-title" id="myModalLabel9" style="color: white;"> <b>TAMBAH POLIGIGI</b></h4>
                 ...
                 <div class="modal-body">
                                  ...
                                  <div class="col-12 col-md-12" style="margin-bottom: 12px;">
                                        ...
                                        <select class="form-control" name="id_pasien" required>
                                          ...
                                          <?php foreach ($this->db->query("SELECT * FROM pendaftaran pf LEFT JOIN pasien pn on pn.id_pasien = pf.id_pasien where pf.id_poli = '1' group by pf.id_pasien;")->result_array() as $key):?>
...
<!--Update Data-->
  <?php foreach ($data_poligigi->result_array() as $i) :
                                            $id_poligigi=$i['id_poligigi'];
                                          ?>
       <form  action="<?php echo base_url().'poligigi/update_poligigi'?>" method="post" enctype="multipart/form-data">
   <div class="form-group">
                          <div class="modal fade text-left" id="ModalUpdate<?php echo $id_poligigi;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel9"
                          aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content">
                                <div class="modal-header bg-info white">
                                  <h4 class="modal-title" id="myModalLabel9" style="color: white;"> <b>UPDATE POLIGIGI</b></h4>
                                  <button  type="button"  class="close"  data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true" >&times;</span>
                                  </button>
                                </div>
                 ...
                 <div class="modal-body">
                       ...
                       <input type="hidden" name="id_poligigi" value="<?php echo $id_poligigi;?>">
 ...
 <?php endforeach;?>
   ...
   <?php foreach ($data_poligigi->result_array() as $i) :
                                            $id_poligigi=$i['id_poligigi'];
                                          ?>
       <form  action="<?php echo base_url().'poligigi/hapus_poligigi'?>" method="post" enctype="multipart/form-data">
   <div class="form-group">
                          <div class="modal fade text-left" id="ModalHapus<?php echo $id_poligigi;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel9"
                          aria-hidden="true">
                          <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content">
                                <div class="modal-header bg-danger white">
                                  <h4 class="modal-title" id="myModalLabel9" style="color: white;"> <b>HAPUS POLIGIGI</b></h4>
                                  <button  type="button"  class="close"  data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true" >&times;</span>
                                  </button>
                                </div>
                 ...
                 <div class="modal-body">
                       ...
                       <input type="hidden" name="kode" value="<?php echo $id_poligigi;?>">
...
<?php if($this->session->flashdata('berhasil_simpan') == TRUE): ?>
 <script type="text/javascript">
   Swal.fire({
  icon: 'success',
  text: 'poligigi Berhasil di SIMPAN',
})
 </script>
<?php endif; ?>
...
<?php if($this->session->flashdata('berhasil_edit') == TRUE): ?>
 <script type="text/javascript">
    Swal.fire({
  icon: 'success',
  text: 'poligigi Berhasil di EDIT'
})
 </script>
<?php endif; ?>
...
<?php if($this->session->flashdata('berhasil_hapus') == TRUE): ?>
 <script type="text/javascript">
     Swal.fire({
  icon: 'success',
  text: 'poligigi Behasil di HAPUS'
})
 </script>
<?php endif; ?>

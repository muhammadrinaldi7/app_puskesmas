                    ...
                    <form  action="<?php echo base_url().'pendaftaran/simpan_pendaftaran'?>" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="col-12 col-md-12" style="margin-bottom: 12px;">
                                        <label class="form-label" >Dokter </label>
                                          <?php foreach ($this->db->query("SELECT * FROM dokter LEFT JOIN poli ON dokter.id_poli = poli.id_poli where dokter.id_poli= '1';")->result_array() as $key):?>
                                  ...
                                  <div class="col-12 col-md-12" style="margin-bottom: 12px;">
                                        ...
                                        <input type="hidden" name="id_poli" value="<?php echo '1' ?>>"id="">
                                        <input type="text" class="form-control" readonly value="<?php echo 'POLI GIGI'?>"id="">
                                  </div> 

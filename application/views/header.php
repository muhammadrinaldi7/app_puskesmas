...
<head>
	...
	<link rel="icon" href="<?php echo base_url();?>/assets/logo2.png" type="image/x-icon"/>
...
<body>
	<div class="wrapper">
		<div class="main-header">
			<!-- Logo Header -->
			<div class="logo-header" style="background-color: #00a65a!important;">
				
				<a href="#" class="logo">
					<img src="<?php echo base_url();?>/assets/logo2.png" width="40px" alt="navbar brand" class="navbar-brand">
				</a>
			...
			<!-- Navbar Header -->
			<nav class="navbar navbar-header navbar-expand-lg" data-background-color="blue2" style="background-color: #00a65a!important;">
									...
									<li>
										<div class="user-box">
											<div class="avatar-lg">
												...
												<?php else:?>
													<img src="<?php echo base_url();?>/assets/image/<?php echo $this->session->userdata('foto');?>g" alt="image profile" class="avatar-img rounded">
												<?php endif;?>
											</div>
											<div class="u-text">
